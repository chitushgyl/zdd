...
//一对一
    public function systemAdmin(){
        //参数：关联模型名称，外键，主键
        //如果主键是id可以省略
        return $this->hasOne('App\Models\Group\SystemAdmin','login','admin_login');
    }

    public function tmsGroup(){
        //参数：关联模型名称，外键，主键
        //如果主键是id可以省略
        return $this->hasOne('App\Models\Tms\TmsGroup','self_id','company_id');
    }
    ...
    public function userCapital(){
        //参数：关联模型名称，外键，主键
        //如果主键是id可以省略
        return $this->hasOne('App\Models\User\UserCapital','total_user_id','total_user_id');
    }
    public function tmsDriver(){
        //参数：关联模型名称，外键，主键
        //如果主键是id可以省略
        return $this->hasOne('App\Models\Tms\TmsDriver','self_id','driver_id');
    }
    public function tmsAttestation(){
        //参数：关联模型名称，外键，主键
        //如果主键是id可以省略
