...
/**
    ...
    public function switchover(Request $request){
       ...
       // $self_id='identity_202101271511561323937379';
        ...
        $user_token=null;
        if($info->type =='TMS3PL' || $info->type == 'company' || $info->type == 'business' || $info->type == 'dispatcher'){
            ...
            $token_data['group_name']    = $info->systemAdmin->group_name;
            $token_data['group_code']    = $info->systemAdmin->group_code;
