...
class GroupController extends Controller{
    ...
    public function  groupList(Request $request){
        ...
        $data['import_info']    =[
            ...
            'import_color'=>'#FC5854',
            'import_url'=>config('aliyun.oss.url').'execl/2020-07-02/TMS业务公司导入文件范本.xlsx',
        ];
        $msg['code']=200;
        $msg['msg']="数据拉取成功";
        $msg['data']=$data;
    ...
    public function groupPage(Request $request){
        ...
        $select=['self_id','company_name','create_user_name','type','group_name','company_name',
            'cost_type','contacts','address','tel','use_flag'];
...
//        dd($msg);
    ...
    public function createGroup(Request $request){
        ...
        $data['info']->type_show=$tms_group_type[$data['info']->type]??null;
        $data['info']->cost_type_show=$tms_cost_type[$data['info']->cost_type]??null;
        $msg['code']=200;
        $msg['msg']="数据拉取成功";
        $msg['data']=$data;
        //dd($msg);
